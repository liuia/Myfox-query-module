...
var Mysql   = require('../node_modules/mysql-libmysqlclient/lib/mysql-libmysqlclient.js');
var fs      = require('fs');
...
var mysql = function(config){
  ...
  conn.initSync();
  conn.setOptionSync(Mysql.MYSQL_OPT_CONNECT_TIMEOUT, 2);
  conn.setOptionSync(Mysql.MYSQL_OPT_READ_TIMEOUT, config.readTimeout);
  conn.setOptionSync(Mysql.MYSQL_OPT_WRITE_TIMEOUT, config.writeTimeout);
